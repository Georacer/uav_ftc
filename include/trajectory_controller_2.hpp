...
#define NUM_INPUTS 4 // slack variable is initialized to 0 and never changed
...
private:
    ...
    Eigen::Matrix<float, NUM_INPUTS, 1> refInputs_; // Stores reference inputs
    Eigen::Matrix<float, NUM_INPUTS, 1> predictedControls_; // Stores control outputs
    ros::Time tprev;
